      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          ...
          onChanged: (newValue) {
            setState(() {
              ...
              tbs.forEach((element) {
                if (element.hang == currentSelectedValue) {
                  ...
                  sharedPrefsHelper.addStringToSF(Constants.PREF_HANG, mahang);
                }
              });
            ...
            print(
                '_TestScreenState.dropdownDepartment dropDownItemsModel $dropDownItemsModel');
          },
          items: dropDownItems.map((String value) {
            return DropdownMenuItem<String>(
              ...
              child: Text(
                value,
                style:
                TextStyle(color: activeColor1, fontWeight: FontWeight.bold),
              ),
            );
          }).toList(),
        ),
      ...
      child: DropdownButtonHideUnderline(
        child: DropdownButton<String>(
          ...
          onChanged: (newValue) {
            setState(() {
              model = newValue;
              sharedPrefsHelper.addStringToSF(Constants.PREF_MODEL, model);
...
// dropDownItemsModel.clear();
            ...
            print(
                '_TestScreenState.dropdownModelAir dropDownItemsModel $dropDownItemsModel');
          },
  ...
  void getModel() async {
    Airconditional a = Airconditional(
      mahang,
      '',
      '',
      '',
...
//khanhlh
        mahang = await sharedPrefsHelper.getStringValuesSF(Constants.PREF_HANG);
        print('_AirConditionerState.handleDeviceMahang $mahang');
        if (firstTime) {
          getModel();
        }
        setState(() {});
...
// listModel.clear();
        ...
        if (firstTime) {
          // model =
          // await sharedPrefsHelper.getStringValuesSF(Constants.PREF_MODEL);
          firstTime = false;
        } else {
          model = dropDownItemsModel[0];
        }
        setState(() {});
        break;
    }
